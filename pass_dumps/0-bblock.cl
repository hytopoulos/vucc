...
2: (1)->.->(3 4)
  7:(set i16 (reg "_e") (call i16 (const i16 "label_C054C9") (rsh i16 (add i16 (get i16 (add i16 (const i16 "DATA_C200B9") (mul i16 (get i16 (reg "i")) (const i16 2)))) (get i16 (const i16 "MEM_5DAC"))) (const i16 3)) (rsh i16 (add i16 (get i16 (add i16 (const i16 "DATA_C200C5") (mul i16 (get i16 (reg "i")) (const i16 2)))) (get i16 (const i16 "MEM_5DAE"))) (const i16 3))))
