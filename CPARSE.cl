...
(defun noregparam-fun (idns) (dolist (idn idns) (putiprop (ident idn) 'noregparam t)))(defmacro noregparam (&rest idns) (list 'noregparam-fun (list 'quote idns)))(defmacro asm (idn gen) (list 'putiprop (list 'ident (list 'quote idn)) ''asm (list 'quote gen)))(setq *debug* nil)(setq *gc-control* 200000)
...
(defun fxcp (ccodef) (test-parser ccodef "ld-fx.cl"))(load "pmain.cl")
